...
export const GUIDES = {
  ...
  "iv-speech": {
    ...
    steps: [
      {
        head: "완성한 답변을 말로 바꾸는 곳이에요",
        body: "기본 인성·생기부·기출 탭에서 [답변 완성]을 누른 답변이 여기 연습 문제로 올라와요.",
      },
      {
        head: "5단계로 조금씩 가려요",
        body: "한 블록 → 두 블록 → 첫 블록만 → 구조만 → 질문만. 가려진 문단을 내 말로 풀어서 말하면 돼요. 글자 그대로 외울 필요는 없어요.",
      },
      {
        head: "70%를 넘으면 다음 단계",
        body: "말한 내용에 답변의 핵심이 얼마나 살아 있는지 봅니다. 자주 빠뜨리는 부분은 다음 연습에서 먼저 가려져요.",
      },
    ],
  },
  ...
  "ti-insung": {
    ...
    steps: [
      ...
      {
        head: "진도에 맞춰 탭을 열어주세요",
        body: "처음에는 기본 인성만 열려 있어요. 생기부는 질문을 보내면 자동으로 열리고, 기출문제·면접 시뮬레이션 같은 탭은 여기서 눌러 열어줘야 학생이 볼 수 있습니다. 학생마다 따로 정해요.",
        target: "ti-open-tabs",
      },
      {
        head: "탭마다 첨삭할 수 있어요",
  ...
  "ti-saenggibu": {
    ...
    steps: [
      ...
      {
        head: "보내야 학생에게 보여요",
        body: "만든 질문은 [미전송]으로 쌓여 있다가, [저장 및 보내기]를 누르면 학생 화면에 나타납니다. 이때 학생의 생기부 탭도 자동으로 열려요.",
        target: "ti-sendq",
      },
      {
