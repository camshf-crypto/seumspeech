import { KIDS_LOGIC, LINKS } from "../config";
...
export default function KidsLogic() {
  const K = KIDS_LOGIC;
  ...
  return (
    <div className="bg-white pt-16">
      <div className="border-b border-slate-100 bg-slate-50 py-12 text-center">
        ...
        <h1 className="mt-2 text-3xl font-extrabold text-slate-800">논리 스피치</h1>
      </div>

      <section className="py-20">
        <div className="mx-auto max-w-3xl px-6 text-center">
          <h2 className="mb-6 text-2xl font-bold text-slate-800">
            논리 스피치<span className="text-seum-blue">란?</span>
          </h2>
      ...
      <section className="pb-20">
        <div className="mx-auto max-w-3xl px-6">
          <div className="rounded-3xl bg-slate-50 px-8 py-12 text-center">
            ...
            <p className="mb-7 text-slate-500">조리 있고 자신감 있는 말하기, 지금 시작할 수 있습니다.</p>
