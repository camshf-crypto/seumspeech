...
export default function NotificationsTab({ userId, onGoTab, onRead }) {
    ...
    <div>
      <div className="mb-3 flex items-center justify-between">
        ...
        {unreadCount > 0 ? (
          <button
            onClick={markAllRead}
            className="text-sm font-medium text-seum-blue hover:underline"
          >
            모두 읽음
          </button>
        ) : null}
          ...
          {items.map((n) => {
            ...
            return (
              ...
              >
                ...
                {unread ? (
                  <span className="mt-1 h-2 w-2 shrink-0 rounded-full bg-seum-blue" />
                ) : null}
              </button>
            );
          })}
